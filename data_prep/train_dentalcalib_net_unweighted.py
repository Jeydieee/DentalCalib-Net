...
def train_dentalcalib_net(X, y, model_name, epochs=100, patience=10, batch_size=512, lr=1e-3):
    ...
    # Deviation #5 reverted: plain unweighted BCE, no pos_weight
...
if __name__ == "__main__":
    ...
    print("\n=== Training DentalCalib-Net for yolov8 (unweighted BCE) ===")
    ...
    }, f"{OUTPUT_DIR}/dentalcalib_net_yolov8_unweighted.pt")
    print(f"  Saved -> {OUTPUT_DIR}/dentalcalib_net_yolov8_unweighted.pt")

    # RT-DETR -- increased epoch cap to 300, since it hadn't converged at 100
    print("\n=== Training DentalCalib-Net for rtdetr (unweighted BCE) ===")
    ...
    torch.save({
        ...
        'feature_std': feat_std,
        'best_val_loss': best_val_loss,
    }, f"{OUTPUT_DIR}/dentalcalib_net_rtdetr_unweighted.pt")
    print(f"  Saved -> {OUTPUT_DIR}/dentalcalib_net_rtdetr_unweighted.pt")
